                ...
                <div className="card-item">
                    ...
                    <span>
                        <div className="card-lable">
                            ...
                            <input id="username" type="username" placeholder="UserName" className="card-input" width= "400px"
                                onChange = {e => setUsername(e.target.value)}/>
                        </div>
                ...
                <div className="card-item">
                    ...
                    <span>
                        <div className="card-lable">
                            ...
                            <input id="cur_pass" type="password" placeholder="**********" className="card-input" width="400px"
                                onChange = {e => setPasswordOld(e.target.value)}/>
                        </div>
                    </span>
                </div>
                <div className="card-item">
                    ...
                    <span>
                        <div className="card-lable">
                            ...
                            <input id="new_pass" type="password" placeholder="**********" className="card-input" width="400px"
                                onChange = {e => setPasswordNew(e.target.value)}/>
                        </div>
                    </span>
                </div>
                <div className="card-item">
                    <span margin-right="20px"> Confirm new Password:</span>
                    <span>
                        <div className="card-lable">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19 11H5C3.89543 11 3 11.8954 3 13V20C3 21.1046 3.89543 22 5 22H19C20.1046 22 21 21.1046 21 20V13C21 11.8954 20.1046 11 19 11Z" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            ...
                            <input id="confirm_new_pass" type="password" placeholder="**********" className="card-input" width="400px"
                                onChange = {e => setPasswordConfirm(e.target.value)}/>
                        </div>
                    </span>
                </div>
